  ...
  grunt.initConfig({
    ...
    ts:      {
      options: {
        ...
        module:             'es2015',                 // target javascript module style. [amd (default) | commonjs]
    ...
    jshint: {
      options: {
        ...
        ignores:  ['<%= yeoman.app %>/scripts/classes.js']
      },
      all:     {
        src: [
          'Gruntfile.js',
